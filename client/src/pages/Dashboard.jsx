      ...
      <div className="container">
        ...
        <div className="dashboard-grid">
          <div className="dashboard-card card">
            ...
            <p>
              This is a static section that appears for all users regardless of
              their role.
            </p>
          ...
          {hasPermission("view_users") && (
            <div className="dashboard-card card">
              ...
              <p>
                This section is only visible to users with permission to view
                users.
              </p>
              <p>
                Your role ({user?.role}) has access to user management features.
              </p>
            </div>
          )}
          ...
          {hasPermission("view_roles") && (
            <div className="dashboard-card card">
              ...
              <p>
                Your role ({user?.role}) has access to role management features.
              </p>
            </div>
          )}
